...
export default function GetStartedButton({
    ...
    return (
        <div className="min-h-12 w-64">
            <button
                className={cn(
                    "group flex h-12 w-64 items-center justify-center gap-3 rounded-lg bg-primary p-2 font-bold transition-colors duration-100 ease-in-out hover:bg-main cursor-pointer",
                    className,
                )}
            >
        <span
            className={cn(
                "text-main transition-colors duration-100 ease-in-out group-hover:text-primary",
            )}
        >
          {text}
        </span>
                <div
                    className={cn(
                        ...
                        "bg-main group-hover:bg-primary",
                    )}
                >
