...
export default function InteractiveGrid({
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(123deg, transparent 0%, transparent 36%,#56567655 36%, #56567611 56%,transparent 56%, transparent 100%),linear-gradient(251deg, transparent 0%, transparent 68%,rgba(3, 3, 3, 0.05) 68%, rgba(3, 3, 93,0.02) 99%,transparent 99%, transparent 100%),linear-gradient(135deg, #565676,rgb(120, 120, 169))",
      }}
    >
      <Grid />
